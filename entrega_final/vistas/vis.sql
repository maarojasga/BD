...
/* VISTAS PUBLICAS                                                   */
/*==============================================================*/
CREATE VISTA_PUBLICA_CLIENTES_VIEW
AS
    SELECT *
    FROM CLIENTES
GO
CREATE VISTA_PUBLICA_PROVEEDORES_VIEW
AS
    SELECT *
    FROM PROVEEDORES
GO
CREATE VISTA_PUBLICA_EMPLEADOS_VIEW
AS
    SELECT *
    FROM EMPLEADOS
GO
CREATE VISTA_PUBLICA_VENDEDORES_VIEW
AS
    SELECT *
    FROM VENDEDORES
GO
CREATE VISTA_REGISTRO_HISTORICO_VIEW
AS
    SELECT *
