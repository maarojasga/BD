...
/* Created on:     19/11/2020 10:07:47 a. m.                    */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('CARGO') and o.name = 'FK_CARGO_DEFINIR_S_RANGO')
alter table CARGO
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('INVENTARIO') and o.name = 'FK_INVENTAR_RELATIONS_PRE_COMP')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('INVENTARIO') and o.name = 'FK_INVENTAR_RELATIONS_POS_COMP')
alter table INVENTARIO
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('LISTA_CANDIDATOS') and o.name = 'FK_LISTA_CA_SELECCION_DEPARTAM')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('LISTA_CANDIDATOS') and o.name = 'FK_LISTA_CA_VACANTES_CARGO')
alter table LISTA_CANDIDATOS
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('POS_COMPRA') and o.name = 'FK_POS_COMP_RECIBE_CLIENTE')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('PRE_COMPRA') and o.name = 'FK_PRE_COMP_RELATIONS_CLIENTE')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('PRODUCTO') and o.name = 'FK_PRODUCTO_EXISTENCI_INVENTAR')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP1_DEPARTAM')
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP2_DEPARTAM')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP3_DEPARTAM')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP4_DEPARTAM')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP5_DEPARTAM')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_DEP6_DEPARTAM')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_RELATIONS_INVENTAR')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('SUCURSAL') and o.name = 'FK_SUCURSAL_TIENE_EMPRESA')
alter table SUCURSAL
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('VENDER') and o.name = 'FK_VENDER_VENDER_EMPLEADO')
alter table VENDER
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('VENDER') and o.name = 'FK_VENDER_VENDER2_PRODUCTO')
alter table VENDER
...
create nonclustered index ADQUISICION_FK on ADQUISICION (CLIENTEID ASC)
go
...
create nonclustered index ADQUISICION2_FK on ADQUISICION (PRODUCTOID ASC)
go
...
create nonclustered index DEFINIR_SALARIO_FK on CARGO (MAX_SALARIO ASC)
go
...
create nonclustered index UBICACION2_FK on CIUDAD (SUCURSALID ASC)
go
...
create nonclustered index REPRESENTANTE3_FK on CLIENTE (GERENTE_CLIENTEID ASC)
go
...
create nonclustered index LUGARVENTA_FK on CLIENTE (SUCURSALID ASC)
go
...
create nonclustered index ENCARGADO_FK on CLIENTE (EMPLEADO_VENDEDORID ASC)
go
...
create nonclustered index PERTENECE_FK on EMPLEADO (CARGOID ASC)
go
...
create nonclustered index CONTRATO_FK on EMPLEADO (SUCURSALID ASC)
go
...
create nonclustered index CONTRATOVENDEDOR_FK on EMPLEADO_VENDEDOR (SUCURSALID ASC)
go
...
create nonclustered index REPRESENTANTE2_FK on GERENTE_CLIENTE (CLIENTEID ASC)
go
...
create nonclustered index REPRESENTAR3_FK on GERENTE_PROVEEDOR (PROVEEDORID ASC)
go
...
create table HISTORIAEMPLEADO (
   ...
   HISTORIA_FECHAINGRESO datetime             not null,
   HISTORIA_FECHARETIRO datetime             not null,
   ...
   HISTORIA_FECHACAMBIOCARGO datetime             not null,
...
create nonclustered index RELATIONSHIP_23_FK on INVENTARIO (PRECOMPRA_ID ASC)
go
...
create nonclustered index RELATIONSHIP_26_FK on INVENTARIO (POSCOMPRA_ID ASC)
go
...
create nonclustered index SELECCION_FK on LISTA_CANDIDATOS (RECURSOSHUMANOS_ID ASC)
go
...
create nonclustered index VACANTES_FK on LISTA_CANDIDATOS (CARGOID ASC)
go
...
create table POS_COMPRA (
   ...
   CLIENTEID            int                  null,
   POSCOMPRA_FECHA      datetime             not null,
...
create nonclustered index RECIBE_FK on POS_COMPRA (CLIENTEID ASC)
go
...
create table PRE_COMPRA (
   ...
   CLIENTEID            int                  null,
   PRECOMPRA_FECHA      datetime             not null,
...
create nonclustered index RELATIONSHIP_24_FK on PRE_COMPRA (CLIENTEID ASC)
go
...
create nonclustered index PROVEER_FK on PRODUCTO (PROVEEDORID ASC)
go
...
create nonclustered index EXISTENCIA_FK on PRODUCTO (INVENTARIO_ID ASC)
go
...
create nonclustered index REPRESENTAR2_FK on PROVEEDOR (GERENTE_PROVEEDORID ASC)
go
...
create nonclustered index NN_FK on PROVEEDOR (SUCURSALID ASC)
go
...
create nonclustered index UBICACION3_FK on SUCURSAL (CIUDADID ASC)
go
...
create nonclustered index TIENE_FK on SUCURSAL (EMPRESA_NOMBRE ASC)
go
...
create nonclustered index DEP1_FK on SUCURSAL (SISTEMAS_ID ASC)
go
...
create nonclustered index DEP2_FK on SUCURSAL (JURIDICO_ID ASC)
go
...
create nonclustered index DEP3_FK on SUCURSAL (CONTABILIDAD_ID ASC)
go
...
create nonclustered index DEP4_FK on SUCURSAL (VENTAS_ID ASC)
go
...
create nonclustered index DEP5_FK on SUCURSAL (MERCADEO_ID ASC)
go
...
create nonclustered index DEP6_FK on SUCURSAL (RECURSOSHUMANOS_ID ASC)
go
...
create nonclustered index RELATIONSHIP_27_FK on SUCURSAL (INVENTARIO_ID ASC)
go
...
create nonclustered index VENDER_FK on VENDER (EMPLEADO_VENDEDORID ASC)
go
...
create nonclustered index VENDER2_FK on VENDER (PRODUCTOID ASC)
go
